...
Splitting the vector and then reading each third word:
```{r}
strsplit(Gettysburg, " ")
Gettysburg[seq(from = 1, to = 30, by = 3)]
```
<span style="color:red"> **Why is this not working!?**</span>

Other but very similar possibility is by using the StringR package:
```{r}
